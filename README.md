...
A little arcade of nine classic games that runs in a web browser. No sign-up,
...
Open **`index.html`** — that is the home page. It shows a list of the nine
...
| **Snake** | Eat apples, grow long, don't hit a wall | Arrow keys, WASD, or swipe |
...
Six of the games remember your personal best on the device you played on:
